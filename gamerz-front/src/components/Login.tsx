    ...
    return (
        <>
            <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                <form
                    className="fieldset flex flex-col items-center w-lg bg-base-200 border border-base-300 p-4 rounded-box"
                    ...
                    <button className="btn btn-soft btn-primary text-base mt-4" type="submit"
                            disabled={!isDirty || !isValid || isSubmitting}>Login
                    </button>
                    {isSubmitting && (
                        <div role="status">
                            <svg
                ...
                <p className="mt-10 text-center text-sm/6 text-gray-500">
                    Not a member?
                    <Link to="/register"
                          className="font-semibold text-primary hover:text-indigo-300 hover:transition"> Register
                        here! </Link>
                </p>
            </div>
        </>
