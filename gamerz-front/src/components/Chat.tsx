            ...
            <div className="max-w-full mx-auto my-auto">
                ...
                <form>
                    ...
                    <div className="flex items-center py-2 px-3 rounded-lg bg-base-300">
                        <textarea value={message} id="chat" className="block mx-4 p-2.5 w-[80%] text-sm text-gray-900 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-base-100 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your message..."></textarea>
                        <button onClick={() => handleSend()} type="submit" className="inline-flex justify-center p-2 text-blue-600 rounded-full cursor-pointer hover:bg-blue-100 dark:text-primary">
